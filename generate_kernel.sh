...
sudo cp output/Image.gz /media/marcinamc/rootfs/boot/Image.gz
sudo cp output/imx8mm-var-dart-dt8mcustomboard-legacy.dtb /media/marcinamc/rootfs/boot/imx8mm-var-dart-dt8mcustomboard-legacy.dtb
sudo sync
